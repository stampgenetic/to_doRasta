<?php
// Iniciar a sessão para gerenciar o estado do usuário (login, etc.)
session_start();
...
$auth->checkLogin(); // Garante que apenas usuários logados acessem

$taskManager = new Task($dbConnection);

// 2. Lógica para manipulação de tarefas (CUD - Create, Update, Delete)
$action = $_POST['action'] ?? '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Redireciona via GET para evitar reenvio do formulário com F5
    header('Location: index.php');
    exit;
}

// 3. Busca todas as tarefas para exibição
